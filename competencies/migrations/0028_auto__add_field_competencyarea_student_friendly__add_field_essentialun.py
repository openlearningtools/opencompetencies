...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'CompetencyArea.student_friendly'
        db.add_column(u'competencies_competencyarea', 'student_friendly',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'EssentialUnderstanding.student_friendly'
        db.add_column(u'competencies_essentialunderstanding', 'student_friendly',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'CompetencyArea.student_friendly'
        db.delete_column(u'competencies_competencyarea', 'student_friendly')

        # Deleting field 'EssentialUnderstanding.student_friendly'
        db.delete_column(u'competencies_essentialunderstanding', 'student_friendly')
