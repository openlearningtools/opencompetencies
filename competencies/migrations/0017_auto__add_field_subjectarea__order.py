...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubjectArea._order'
        db.add_column(u'competencies_subjectarea', '_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubjectArea._order'
        db.delete_column(u'competencies_subjectarea', '_order')
