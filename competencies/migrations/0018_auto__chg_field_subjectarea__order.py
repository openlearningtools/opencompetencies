...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'SubjectArea._order'
        db.alter_column(u'competencies_subjectarea', '_order', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'SubjectArea._order'
        db.alter_column(u'competencies_subjectarea', '_order', self.gf('django.db.models.fields.IntegerField')(null=True))
