...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field subject_areas on 'UserProfile'
        db.create_table(u'competencies_userprofile_subject_areas', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'competencies.userprofile'], null=False)),
            ('subjectarea', models.ForeignKey(orm[u'competencies.subjectarea'], null=False))
        ))
        db.create_unique(u'competencies_userprofile_subject_areas', ['userprofile_id', 'subjectarea_id'])


    def backwards(self, orm):
        # Removing M2M table for field subject_areas on 'UserProfile'
        db.delete_table('competencies_userprofile_subject_areas')
