...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'LearningTarget._order'
        db.alter_column(u'competencies_learningtarget', '_order', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'LearningTarget._order'
        db.alter_column(u'competencies_learningtarget', '_order', self.gf('django.db.models.fields.IntegerField')(null=True))
