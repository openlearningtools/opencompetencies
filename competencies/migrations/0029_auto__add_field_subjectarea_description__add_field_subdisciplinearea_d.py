...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubjectArea.description'
        db.add_column(u'competencies_subjectarea', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'SubdisciplineArea.description'
        db.add_column(u'competencies_subdisciplinearea', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'LearningTarget.description'
        db.add_column(u'competencies_learningtarget', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'CompetencyArea.description'
        db.add_column(u'competencies_competencyarea', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)

        # Adding field 'EssentialUnderstanding.description'
        db.add_column(u'competencies_essentialunderstanding', 'description',
                      self.gf('django.db.models.fields.TextField')(default='', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubjectArea.description'
        db.delete_column(u'competencies_subjectarea', 'description')

        # Deleting field 'SubdisciplineArea.description'
        db.delete_column(u'competencies_subdisciplinearea', 'description')

        # Deleting field 'LearningTarget.description'
        db.delete_column(u'competencies_learningtarget', 'description')

        # Deleting field 'CompetencyArea.description'
        db.delete_column(u'competencies_competencyarea', 'description')

        # Deleting field 'EssentialUnderstanding.description'
        db.delete_column(u'competencies_essentialunderstanding', 'description')
