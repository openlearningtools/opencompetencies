...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SubjectArea.public'
        db.add_column(u'competencies_subjectarea', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'Level.public'
        db.add_column(u'competencies_level', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'SubdisciplineArea.public'
        db.add_column(u'competencies_subdisciplinearea', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'CompetencyArea.public'
        db.add_column(u'competencies_competencyarea', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)

        # Adding field 'EssentialUnderstanding.public'
        db.add_column(u'competencies_essentialunderstanding', 'public',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SubjectArea.public'
        db.delete_column(u'competencies_subjectarea', 'public')

        # Deleting field 'Level.public'
        db.delete_column(u'competencies_level', 'public')

        # Deleting field 'SubdisciplineArea.public'
        db.delete_column(u'competencies_subdisciplinearea', 'public')

        # Deleting field 'CompetencyArea.public'
        db.delete_column(u'competencies_competencyarea', 'public')

        # Deleting field 'EssentialUnderstanding.public'
        db.delete_column(u'competencies_essentialunderstanding', 'public')
