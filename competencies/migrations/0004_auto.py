...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field subject_areas on 'Pathway'
        db.create_table(u'competencies_pathway_subject_areas', (
        ...
        db.create_unique(u'competencies_pathway_subject_areas', ['pathway_id', 'subjectarea_id'])


    def backwards(self, orm):
        # Removing M2M table for field subject_areas on 'Pathway'
        db.delete_table('competencies_pathway_subject_areas')
