...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field subdiscipline_areas on 'Pathway'
        db.create_table(u'competencies_pathway_subdiscipline_areas', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('pathway', models.ForeignKey(orm[u'competencies.pathway'], null=False)),
            ('subdisciplinearea', models.ForeignKey(orm[u'competencies.subdisciplinearea'], null=False))
        ))
        db.create_unique(u'competencies_pathway_subdiscipline_areas', ['pathway_id', 'subdisciplinearea_id'])


    def backwards(self, orm):
        # Removing M2M table for field subdiscipline_areas on 'Pathway'
        db.delete_table('competencies_pathway_subdiscipline_areas')
    ...
    models = {
        ...
        u'competencies.pathway': {
            ...
            'subdiscipline_areas': ('django.db.models.fields.related.ManyToManyField', [], {'to': u"orm['competencies.SubdisciplineArea']", 'symmetrical': 'False'}),
