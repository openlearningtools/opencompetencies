...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'Level', fields ['competency_area', 'level_type']
        db.create_unique(u'competencies_level', ['competency_area_id', 'level_type'])


    def backwards(self, orm):
        # Removing unique constraint on 'Level', fields ['competency_area', 'level_type']
        db.delete_unique(u'competencies_level', ['competency_area_id', 'level_type'])
