...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Level._order'
        db.add_column(u'competencies_level', '_order',
                      self.gf('django.db.models.fields.IntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Level._order'
        db.delete_column(u'competencies_level', '_order')
    ...
    models = {
        ...
        u'competencies.level': {
            'Meta': {'ordering': "(u'_order',)", 'object_name': 'Level'},
