...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'competencies_userprofile', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['auth.User'], unique=True)),
        ))
        db.send_create_signal(u'competencies', ['UserProfile'])

        # Adding M2M table for field schools on 'UserProfile'
        db.create_table(u'competencies_userprofile_schools', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('userprofile', models.ForeignKey(orm[u'competencies.userprofile'], null=False)),
            ('school', models.ForeignKey(orm[u'competencies.school'], null=False))
        ))
        db.create_unique(u'competencies_userprofile_schools', ['userprofile_id', 'school_id'])


    def backwards(self, orm):
        # Deleting model 'UserProfile'
        db.delete_table(u'competencies_userprofile')

        # Removing M2M table for field schools on 'UserProfile'
        db.delete_table('competencies_userprofile_schools')
