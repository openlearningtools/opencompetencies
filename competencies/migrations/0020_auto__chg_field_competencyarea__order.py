...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'CompetencyArea._order'
        db.alter_column(u'competencies_competencyarea', '_order', self.gf('django.db.models.fields.IntegerField')())

    def backwards(self, orm):

        # Changing field 'CompetencyArea._order'
        db.alter_column(u'competencies_competencyarea', '_order', self.gf('django.db.models.fields.IntegerField')(null=True))
