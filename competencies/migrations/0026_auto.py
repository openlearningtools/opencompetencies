...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field pathways on 'UserProfile'
        db.create_table(u'competencies_userprofile_pathways', (
        ...
        db.create_unique(u'competencies_userprofile_pathways', ['userprofile_id', 'pathway_id'])


    def backwards(self, orm):
        # Removing M2M table for field pathways on 'UserProfile'
        db.delete_table('competencies_userprofile_pathways')
